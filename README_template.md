...
| `delete(agreement: Agreement, offer: DetailedOffer, resource: Resource): Promise<*Details>`     | Called when a user closes an Agreement, ensuring the actual resource is deleted.                                                                                                                                                                                                                                                     |
